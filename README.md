...
<!-- HTML snippet for index page
  <tr>
    <td><img src="snippets/dataflow-approval/src/main/resources/process.png" width="100"></td>
    <td><a href="snippets/dataflow-approval">Camunda BPM Process Application</a></td>
